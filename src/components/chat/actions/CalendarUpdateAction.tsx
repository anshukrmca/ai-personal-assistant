        ...
        <div className="flex flex-col gap-1">
          ...
          {isEditing ? (
            <input
              ...
              className="bg-surface border border-border rounded-md px-2 py-1 text-[13px] outline-none focus:border-accent w-full"
            />
          ) : (
        ...
        <div className="flex flex-col gap-1">
          ...
          {isEditing ? (
            <textarea
              ...
              className="bg-surface border border-border rounded-md px-2 py-1 text-[13px] outline-none focus:border-accent w-full min-h-[60px]"
            />
          ) : (
            <div className="flex flex-wrap gap-1.5 mt-0.5">
              {payload.attendees.map((email: string, i: number) => (
                <span
                  key={i}
                  className="bg-[#f1f5f9] text-[#475569] px-2 py-0.5 rounded-md text-[11px] font-bold"
                >
                  {email}
                </span>
              ))}
